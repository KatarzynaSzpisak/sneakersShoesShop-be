...
namespace onlineTShirtShop.Migrations
{
    ...
    [Migration("20200123134325_orderdetails")]
            ...
            modelBuilder.Entity("onlineTShirtShop.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Tanya",
                            LastName = "L",
                            Registered = new DateTime(2019, 12, 4, 14, 43, 24, 708, DateTimeKind.Local).AddTicks(5160),
                            Telephone = 123456789
                        },
                        new
                        {
                            ...
                            FirstName = "Dima",
                            LastName = "L",
                            Registered = new DateTime(2020, 1, 13, 14, 43, 24, 719, DateTimeKind.Local).AddTicks(7640),
                            Telephone = 123456789
                        },
                        new
                        {
                            ...
                            FirstName = "Kolya",
                            LastName = "L",
                            Registered = new DateTime(2020, 1, 18, 14, 43, 24, 719, DateTimeKind.Local).AddTicks(7800),
                            Telephone = 123456789
                        });
                });
            ...
            modelBuilder.Entity("onlineTShirtShop.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2020, 1, 23, 14, 43, 24, 720, DateTimeKind.Local).AddTicks(690),
                            CustomerId = 1,
                            Status = "payd"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2020, 1, 23, 11, 43, 24, 720, DateTimeKind.Local).AddTicks(1500),
                            CustomerId = 2,
                            Status = "onpayd"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2020, 1, 21, 14, 43, 24, 720, DateTimeKind.Local).AddTicks(1580),
                            CustomerId = 3,
                            Status = "basket"
                        });
                });
