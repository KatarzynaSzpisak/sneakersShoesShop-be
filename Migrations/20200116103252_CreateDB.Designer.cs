...
namespace onlineTShirtShop.Migrations
{
    ...
    [Migration("20200116103252_CreateDB")]
            ...
            modelBuilder.Entity("onlineTShirtShop.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Tanya",
                            LastName = "L",
                            Registered = new DateTime(2019, 11, 27, 11, 32, 51, 934, DateTimeKind.Local).AddTicks(1150),
                            Telephone = 123456789
                        },
                        new
                        {
                            ...
                            FirstName = "Dima",
                            LastName = "L",
                            Registered = new DateTime(2020, 1, 6, 11, 32, 51, 942, DateTimeKind.Local).AddTicks(5180),
                            Telephone = 123456789
                        },
                        new
                        {
                            ...
                            FirstName = "Kolya",
                            LastName = "L",
                            Registered = new DateTime(2020, 1, 11, 11, 32, 51, 942, DateTimeKind.Local).AddTicks(5330),
                            Telephone = 123456789
                        });
                });
            ...
            modelBuilder.Entity("onlineTShirtShop.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2020, 1, 16, 11, 32, 51, 942, DateTimeKind.Local).AddTicks(8200),
                            CustomerId = 1,
                            Status = "payd"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2020, 1, 16, 8, 32, 51, 942, DateTimeKind.Local).AddTicks(9080),
                            CustomerId = 2,
                            Status = "onpayd"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2020, 1, 14, 11, 32, 51, 942, DateTimeKind.Local).AddTicks(9160),
                            CustomerId = 3,
                            Status = "basket"
                        });
                });
            ...
            modelBuilder.Entity("onlineTShirtShop.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActualCost = 100m,
                            Details = "Unic unicorn tshirt, hand made design",
                            ImageUrl = " ",
                            Name = "Unicorn TShirt",
                            Price = 100m
                        },
